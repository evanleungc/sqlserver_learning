...
1. Excecution plan retention and resuability --Execution Plan: The plan to run the query generated by SQL. 
   They will be cached by SQL for futher reusing¡£
...
2. Reduce Network Traffic
	It means that you don't need to type too many words. If use procedure, it will just a line and it will run on 
	the server rather than using the network traffic
